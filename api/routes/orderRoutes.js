    ...
    try {
        ...
        if (bot && adminChatId) {
            try {
                ...
                const vendorChatId = vendor ? vendor.telegramChatId : null;
...
${itemsText}
                ...
                if (vendorChatId && vendorChatId !== adminChatId) {
                    await bot.sendPhoto(vendorChatId, photoUrl, { caption: message, parse_mode: 'HTML' }).catch(console.error);
                }
